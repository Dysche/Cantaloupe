...
public class ImmutableLocation implements Location {
    ...
    public ImmutableLocation mult(Vector3i vector) {
        return ImmutableLocation.of(new org.bukkit.Location(this.world.getHandle(), this.handle.getX() * vector.x, this.handle.getY() * vector.y, this.handle.getZ() * vector.z));
    }
    ...
    public ImmutableLocation mult(int x, int y, int z) {
        return ImmutableLocation.of(new org.bukkit.Location(this.world.getHandle(), this.handle.getX() * x, this.handle.getY() * y, this.handle.getZ() * z));
    }
    ...
    public ImmutableLocation mult(int n) {
        return ImmutableLocation.of(new org.bukkit.Location(this.world.getHandle(), this.handle.getX() * n, this.handle.getY() * n, this.handle.getZ() * n));
    }
    ...
    public Location clone() {
        return ImmutableLocation.of(this.handle.clone());
    }
