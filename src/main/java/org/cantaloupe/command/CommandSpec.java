...
public class CommandSpec {
	...
	private CommandSpec(String permission, Text usage, Text description, CommandElement args, CommandExecutor executor,
			Map<ErrorType, Text> errors, Map<CommandSpec, List<String>> children) {
	...
	public static final class Builder {
		...
		public CommandSpec build() {
			return new CommandSpec(this.permission, this.usage, this.description, this.args, this.executor, this.errors,
					this.children);
		}
	}
