...
public final class SingleArg {
	...
	public boolean equals(Object o) {
		...
		return this.startIndex == singleArg.startIndex && this.endIndex == singleArg.endIndex
	...
	public String toString() {
		return Objects.toStringHelper(this).add("value", this.value).add("startIdx", this.startIndex)
				.add("endIdx", this.endIndex).toString();
	}
}